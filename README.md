...
Make sure Java is proeprly installed and referenced in your environment, it can be also specified through the options available in the plugins options window.
